...
export default function IceCreamView() {
  ...
  return (
    <div className="relative text-neutral-600">
      ...
      <Sphere size={50} color="#e8e0c8" top="50%" right="36%" zIndex={30} />
      <Sphere size={150} color="#ebce8b" bottom="3%" right="35%" zIndex={0} />
      <Sphere size={110} color="#e8e0c0" bottom="5%" right="61%" zIndex={30} />
